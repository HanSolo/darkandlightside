...
public class EditableDateTimeTableCell<S> extends TableCellFX<S, LocalDateTime> {
    ...
    //******************** Constructors ***************************************
    public EditableDateTimeTableCell() {
        this(null);
    }
    public EditableDateTimeTableCell(final DateTimeFormatter FORMATTER) {
        getStyleClass().add("editable-date-time-cell");
        formatter    = new ObjectPropertyBase<DateTimeFormatter>(DateTimeFormatter.ofPattern("dd.MM.YYYY hh:mm:ss")) {
            @Override public Object getBean() { return EditableDateTimeTableCell.this; }
    ...
    @Override public void commitEdit(final LocalDateTime VALUE) {
        if (!isEditing()) return;
    ...
    @Override public void cancelEdit() {
        if (escapePressed) {
            ...
            commitEdit(datePicker.getDateTimeValue());
            setContentDisplay(ContentDisplay.TEXT_ONLY);
        }
    }

    @Override public void updateItem(final LocalDateTime ITEM, final boolean EMPTY) {
    ...
    private void createDatePicker() {
        datePicker = new DateTimePicker(getItem());
        ...
        datePicker.getEditor().setOnKeyPressed(keyEvent -> {
            TableView tableView   = EditableDateTimeTableCell.this.getTableView();
