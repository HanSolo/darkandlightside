...
package eu.hansolo.fx.darkandlightside.caching;
 ...
 */
public class DemoCanvasBubbles extends Application {
    ...
    @Override public void start(Stage stage) throws Exception {
        ...
        stage.setTitle("Demo Canvas Bubbles");
